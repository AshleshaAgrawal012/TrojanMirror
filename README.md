...
- Visualizing attacker TTPs (Tactics, Techniques & Procedures)
...
You'll see this output confirming everything is ready:

```
============================================================
🚀 Trojan Sandbox Simulation Started
============================================================

🔄 Restoring victim_data to original plaintext state...
   victim_data reset complete.
   Shutdown restore hook registered.

🛍️ Victim Interface:   http://localhost:5000/
🧠 Analyst Dashboard:  http://localhost:5000/dashboard
📄 Behavior Report:    http://localhost:5000/report
🎯 Simulated C2:       192.168.0.99:443
```
